            ...
            {gallery.map((g, i) => {
              ...
              return (
                <motion.figure
                  ...
                  className={`group relative aspect-[4/5] min-w-[78vw] snap-center overflow-hidden rounded-[20px] border border-[rgba(var(--rgb-fg),0.06)] sm:min-w-[52vw] sm:rounded-[24px] md:min-w-0 md:aspect-auto md:h-[360px] lg:h-[400px] ${
                    wide
                      ? "md:col-span-6"
                      : "md:col-span-3"
                  }`}
