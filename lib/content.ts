...
export const gallery = [
  { id: "g1", label: "Luxembourg Drive", ratio: "4 / 5", aspect: 4 / 5 },
  { id: "g2", label: "Cars & Coffee", ratio: "16 / 9", aspect: 16 / 9 },
  { id: "g3", label: "Castle Roads", ratio: "1 / 1", aspect: 1 },
  { id: "g4", label: "Members Night", ratio: "3 / 4", aspect: 3 / 4 },
  { id: "g5", label: "Moselle Line", ratio: "16 / 9", aspect: 16 / 9 },
  { id: "g6", label: "Private Run", ratio: "4 / 5", aspect: 4 / 5 },
] as const;
